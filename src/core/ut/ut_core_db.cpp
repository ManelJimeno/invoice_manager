...
QSqlDatabase db;
std::unique_ptr<core::db::SQLiteTable> table;
core::db::TableIndex indexName{"TestTable_Pk"};
QMap<QString, core::db::Column<core::db::SQLiteDataType>> columns = {
    {"name", core::db::Column<core::db::SQLiteDataType>("name", core::db::SQLiteDataType::TEXT, false, &indexName)},
    {"value", core::db::Column<core::db::SQLiteDataType>("value", core::db::SQLiteDataType::TEXT, true, nullptr)}};

TEST(SQLiteTable, create_table_when_not_exists)
{
    table = std::make_unique<core::db::SQLiteTable>(db, "TestTable", columns);
    table->create();
}
