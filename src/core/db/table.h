...
{
  public:
    CORE_API static const StatementType CREATE;    /**< @brief Represents the CREATE statement type. */
    CORE_API static const StatementType INSERT;    /**< @brief Represents the INSERT statement type. */
    CORE_API static const StatementType DELETE;    /**< @brief Represents the DELETE statement type. */
    CORE_API static const StatementType UPDATE;    /**< @brief Represents the UPDATE statement type. */
    CORE_API static const StatementType SELECT;    /**< @brief Represents the SELECT statement type. */
    CORE_API static const StatementType SELECT_PK; /**< @brief Represents the SELECT_PK statement type. */
 ...
 *
 * @tparam enum_name The enum representing the table's columns.
 */
template <typename enum_name> class Table
{
  ...
  protected:
    ...
    [[nodiscard]] virtual QString createTable()
        const = 0; /**< @brief Creates the SQL CREATE statement for the table. */
    [[nodiscard]] virtual QString createInsert()
        const = 0; /**< @brief Creates the SQL INSERT statement for the table. */
    [[nodiscard]] virtual QString createUpdate()
        const = 0; /**< @brief Creates the SQL UPDATE statement for the table. */
    [[nodiscard]] virtual QString createSelect()
        const = 0; /**< @brief Creates the SQL SELECT statement for the table. */
    [[nodiscard]] virtual QString createSelectPk() const = 0; /**< @brief Creates the SQL SELECT_PK statement. */
    [[nodiscard]] virtual QString createDelete()
        const = 0; /**< @brief Creates the SQL DELETE statement for the table. */
    ...
    QMap<QString, Column<enum_name>> m_columns; /**< @brief A map of columns for the table. */
